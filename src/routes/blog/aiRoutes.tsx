...
import HowToUseGithubCopilotInVscodePage from "../../app/blog/ai-tools/how-to-use-github-copilot-in-vscode/page";
...
const aiRoutes = (
  <>
    ...
    <Route
      path="/blog/ai-tools/how-to-use-github-copilot-in-vscode"
      element={<HowToUseGithubCopilotInVscodePage />}
    />
