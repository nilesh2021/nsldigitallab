        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-8">
            Please read this Disclaimer carefully before using the
             NslDigitlaLabwebsite and services.
          </p>
        ...
        <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              All information provided on the  NslDigitlaLabwebsite is published
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
               NslDigitlaLabprovides digital marketing, SEO, branding, web
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              ...
              services.  NslDigitlaLabdoes not guarantee the accuracy,
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
              ...
              links. This means  NslDigitlaLabmay earn a commission if users
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
               NslDigitlaLabshall not be held liable for any losses, damages, or
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 md:p-10">
            ...
            <p className="text-gray-300 leading-8 text-lg">
               NslDigitlaLabreserves the right to update or modify this
